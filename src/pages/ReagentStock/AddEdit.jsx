        ...
        <Space orientation="vertical" className="w-full" size="middle">
            <div className="flex gap-4">
                <div className="flex-1">
                    <div className="mb-2">
                        试剂柜 <span className="text-red-500">*</span>
                    </div>
                    <Select
                        className="w-full"
                        ...
                        onChange={(val) => {
                            ...
                            if (errors.storage_id)
                                setErrors({ ...errors, storage_id: null });
                        }}
                ...
                <div className="flex-1">
                    <div className="mb-2">
                        所在行号 <span className="text-red-500">*</span>
                    </div>
                    <InputNumber
                        style={{ width: "100%" }}
                        min={1}
                    ...
                    <Input
                        ...
                        onChange={(e) => {
                            ...
                            if (errors.specification)
                                setErrors({ ...errors, specification: null });
                        }}
            ...
            {!isEdit && (
                <div className="flex items-center gap-2">
                    ...
                    <Switch
                        ...
                        onChange={(checked) =>
                            onChange({ ...record, auto_print: checked })
                        }
                    />
                </div>
            )}
                        ...
                        <Button
                            ...
                            onClick={async () => {
                                try {
                                    ...
                                    onChange({
                                        ...record,
                                        lab_code: res.data.data,
                                    });
                                    message.success("扫码成功");
                                } catch (e) {
                                    message.error(
                                        e.message || "扫码失败，请检查设备连接",
                                    );
                                }
                            }}
                        >
            ...
            <div>
                ...
                <Input.TextArea
                    ...
                    onChange={(e) =>
                        onChange({ ...record, description: e.target.value })
                    }
                    maxLength={255}
                    rows={3}
                />
