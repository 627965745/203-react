    ...
    return (
        <Space orientation="vertical" className="w-full" size="middle">
            ...
            <Row gutter={16}>
                <Col span={12}>
                    <div className="mb-2">
                        登录名 (唯一) <span className="text-red-500">*</span>
                    </div>
                    <Input
                        placeholder="请输入登录名"
                        value={record.name || ""}
            ...
            <Row gutter={16}>
                ...
                <Col span={12}>
                    ...
                    <Input
                        ...
                        onChange={(e) =>
                            updateField("signature_file", e.target.value)
                        }
                        maxLength={255}
                    />
                </Col>
                ...
                <Col span={8}>
                    <div className="flex items-center gap-3">
                        ...
                        <Switch
                            ...
                            onChange={(checked) =>
                                updateField("is_manager", checked ? 1 : 0)
                            }
                        />
                    </div>
                </Col>
