            ...
            },
            {
                ...
                render: (_, record) => (
                    <div className="text-[11px] leading-tight">
                        ...
                        <div className="mb-0.5">
                            <span className="text-gray-400">证件:</span>{" "}
                            {record.id_number || "-"}
                        </div>
                        <div>
                    ...
                    <div className="flex flex-wrap gap-1">
                        {roles?.map((r) => (
                            <Tag
                                color="cyan"
                                key={r.id}
                                className="m-0 text-[10px] leading-[16px]"
                            >
                                {r.name}
                            </Tag>
                        ))}
            ...
            },
            {
                ...
                render: (val, record) => (
                    <Switch
                        ...
                        size="small"
                        onChange={(checked) =>
                            handleSwitchEnabled(record, checked)
                        }
                    />
                ),
            },
    ...
    return (
        <>
            ...
            <BatchArrangeModal
                ...
                title="批量关联角色"
                hint="请为所选用户统一分配系统角色（支持多选）："
                comboApi={comboRole}
                arrangeApi={arrangeUser}
                extraKey="role_ids"
